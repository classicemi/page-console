	  ...
	  _createClass(PageConsole, [{
	    ...
	    value: function open() {
	      ...
	      this.tab.addEventListener('click', function (e) {
	        ...
	        for (var _i = 0, _len = _this.tab.childNodes.length; _i < _len; _i++) {
	          _this.tab.childNodes[_i].classList.remove('active');
	        }
	      ...
	      for (var _i2 = 0, _len2 = this.tabs.length; _i2 < _len2; _i2++) {
	        var tabPanel = document.createElement('div');
	        tabPanel.id = '_page-console-' + _hash2.default + '-' + this.tabs[_i2].toLowerCase() + '-panel';
	        this.tabPanels.appendChild(tabPanel);
	      }

	      // environment
	      $('#_page-console-' + _hash2.default + '-environment-panel').appendChild(_environment2.default.container);
	    ...
	    value: function switchTab(type) {
	      ...
	      $('#_page-console-' + _hash2.default + '-' + type.toLowerCase() + '-panel').style.display = 'block';
	    }
	  }]);
	...
	var PageConsoleDefault = function () {
	  ...
	  _createClass(PageConsoleDefault, [{
	    ...
	    value: function print(opt) {
	      ...
	      opt.content.forEach(function (item, idx) {
	        try {
